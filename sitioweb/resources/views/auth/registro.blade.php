    ...
    <div class="block mx-auto my-12 p-8 bg-white w-1/3 border border-gray-200 rounded-lg shadow-lg">
        ...
        <form class="mt-4" enctype="multipart/form-data" action="{{ route('register.store') }}" method="post">
            ...
            <div class="flex">
                ...
                <input accept="image/jpeg,image/png,image/jpg" class=" mr-1 border border-gray-200 rounded-md bg-gray-200 w-full text-lm p-2 my-2 placeholder-gray-500 focus:bg-white" type="file" name="foto" placeholder="Imagen">
                @error('foto')
                <p class="border border-red-500 rounded-md bg-red-100 w-full text-red-600 p-2 my-2">{{ $message }}</p>
            @enderror
            ...
            <button type="submit" name="submit" class="rounded-md bg-indigo-500 w-full text-lg text-white font-semibold p-2 my-3 hover:bg-indigo-600">Enviar Solicitud</button>
